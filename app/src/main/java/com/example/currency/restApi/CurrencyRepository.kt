...
//    }
    ...
    suspend fun getCurrenciesResult(): MutableList<CurrencyResult> {
         ...
         if(currencyApi.getCharacterListDay(yeasDay) != null) {
             return   withContext(Dispatchers.IO) {
    ...
    private suspend fun mist(charCof: String): Double {
        ...
        when (charCof) {
            "AUD" -> { return   getCurrenciesListDay()[0].rate }
            "AMD" -> { return   getCurrenciesListDay()[1].rate }
            "BGN" -> { return   getCurrenciesListDay()[2].rate }
            "UAH" -> { return   getCurrenciesListDay()[3].rate }
            "DKK" -> { return   getCurrenciesListDay()[4].rate }
            "USD" -> { return   getCurrenciesListDay()[5].rate }
            "EUR" -> { return   getCurrenciesListDay()[6].rate }
            "PLN" -> { return   getCurrenciesListDay()[7].rate }
            "JPY" -> { return   getCurrenciesListDay()[8].rate }
            "IRR" -> { return   getCurrenciesListDay()[9].rate }
            "ISK" -> { return   getCurrenciesListDay()[10].rate }
            "CAD" -> { return   getCurrenciesListDay()[11].rate }
            "CNY" -> { return   getCurrenciesListDay()[12].rate }
            "KWD" -> { return   getCurrenciesListDay()[13].rate }
            "MDL" -> { return   getCurrenciesListDay()[14].rate }
            "NZD" -> { return   getCurrenciesListDay()[15].rate }
            "NOK" -> { return   getCurrenciesListDay()[16].rate }
            "RUB" -> { return   getCurrenciesListDay()[17].rate }
            "XDR" -> { return   getCurrenciesListDay()[18].rate }
            "SGD" -> { return   getCurrenciesListDay()[19].rate }
            "KGS" -> { return   getCurrenciesListDay()[20].rate }
            "KZT" -> { return   getCurrenciesListDay()[21].rate }
            "TRY" -> { return   getCurrenciesListDay()[22].rate }
            "GBP" -> { return   getCurrenciesListDay()[23].rate }
            "CZK" -> { return   getCurrenciesListDay()[24].rate }
            "SEK" -> { return   getCurrenciesListDay()[25].rate }
            "CHF" -> { return   getCurrenciesListDay()[26].rate }
        }
